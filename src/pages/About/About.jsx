      ...
      <motion.div initial={{ opacity: 0, scale: 0 }} transition={{ duration: 0.4 }} animate={{ opacity: 1, scale: 1 }} id={styles.container}>
         ...
         <div id={styles.linha}>
            ...
            <div id={styles.right}>
               ...
               <br />
               <p>
                  Além disso, recentemente comecei a utilizar o Firebase como plataforma de back-end para hospedar meus projetos e gerenciar
                  dados. Esta plataforma integrada me permite facilmente gerenciar usuários, autenticação, armazenamento de arquivos e banco de
                  dados em tempo real.
               </p>
               <br />
               <p>
                  Para mim, a chave para criar projetos bem-sucedidos é uma combinação de criatividade, atenção aos detalhes e uma abordagem
                  iterativa. Eu gosto de começar com uma visão clara do que quero criar, mas também estou sempre aberto a ajustar o meu processo
                  de acordo com feedback e novas informações.
               </p>
               <br />
               <p>
